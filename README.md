...
از داخل خود داشبورد هم می‌توانید: **شروع/توقف ربات** (دکمه‌های ▶/■ با
تأیید و پیام نتیجه) و **دانلود داده‌های جمع‌آوری‌شده** به‌صورت اکسل یا CSV
(فقط ردیف‌های دارای شماره/ایمیل) — بدون دست زدن به ترمینال.
