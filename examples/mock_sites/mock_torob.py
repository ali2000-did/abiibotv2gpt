...
# prk-cool-*: محصول هدف کارفرما (مینی کولر شارژی) — برای دمو/تست اتوران
PRODUCTS["prk-cool-1"] = {
    "title": "مینی کولر شارژی قابل حمل ۲۰۰۰ میلی‌آمپر",
    "price": "۸۹۰٬۰۰۰ تومان", "shops": ["shop-5", "shop-8"],
}
PRODUCTS["prk-cool-2"] = {
    "title": "مینی کولر شارژی میوه‌ای سایز کوچک",
    "price": "۶۵۰٬۰۰۰ تومان", "shops": ["shop-9"],
}
PRODUCTS["prk-cool-3"] = {
    "title": "کولر شارژی رومیزی همراه با پاوربانک",
    "price": "۱٬۲۰۰٬۰۰۰ تومان", "shops": ["shop-10", "shop-13"],
}
